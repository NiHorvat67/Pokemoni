...
const inputClassName = "font-inter text-[16px] bg-input-bg rounded-[8px] text-black px-5 py-2 sm:px-5.5 sm:py-3"
    ...
    <div ref={containerRef} className={cn('w-full max-w-sm py-2', className)}>
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex flex-wrap sm:grid sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-white text-sm font-medium mb-2">{cvvLabel}</label>
            <Input
              ref={cvvInputRef}
              type="text"
              placeholder="123"
