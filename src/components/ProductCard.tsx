    ...
    <article className="relative max-w-[320px] font-inter">
      ...
      <div className="bg-[#222423] rounded-[8px] p-6 mt-[-8px] relative shadow-[0_-4px_4px_rgba(0,0,0,0.25)]">
        ...
        <div className="flex items-center justify-between">
          ...
          <a className="text-black px-5 py-2 bg-primary rounded-[8px] hover:shadow-[0_0_15px_#00FA55] transition-shadow duration-300" href={`/advertisement/${advertisementId}`}>Rent</a>
        </div>
      </div>
